        ...
        <div className="px-6 pt-6 pb-5">
          <div className="flex items-start gap-3 mb-5 pr-8">
            ...
            <div className="min-w-0">
              ...
              <p className="text-sm font-semibold text-slate-800 dark:text-zinc-100 leading-snug">{entities.map(e => e.shortName).join(', ')}</p>
            </div>
          </div>
          ...
          <h3 className="text-base font-semibold text-slate-800 dark:text-zinc-100 mt-3 mb-2 leading-snug">
            {item.title}
          </h3>
